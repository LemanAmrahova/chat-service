package com.leman.chatservice.aop;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.leman.chatservice.controller..*(..))")
    public void controllerLayer() {
    }

    @Pointcut("execution(* com.leman.chatservice.service..*(..))")
    public void serviceLayer() {
    }

    @Pointcut("execution(* com.leman.chatservice.controller.AuthController.*(..))")
    public void authController() {
    }

    @Pointcut("execution(* com.leman.chatservice.service.AuthService.*(..))")
